...
public class RepositorioPessoa {
	...
	private RepositorioPessoa() {
		cidades.add("Vit√≥ria");
		cidades.add("Recife");
		cidades.add("N√£o existe");
		cidades.add("Olinda");
		cidades.add("Ribeir√£o");
		cidades.add("Socorro");
	...
	public void iniciarPessoas() {
		...
		Pessoa Jose = new Pessoa("JosÈ Rocha","VitÛria");
		...
		Pessoa MariaGuilia = new Pessoa("Maria Guilia","VitÛria");
		...
		Pessoa Rodrigues = new Pessoa("JosÈ Rodrigues","VitÛria");
		Pessoa Lucas = new Pessoa("Lucas","Boa Viagem");
		Pessoa Fernando = new Pessoa("Luiz Fernando","Camaragibe");
		Pessoa Falcao = new Pessoa("Luiz F. Falc„o","Recife");
	...
	public void acao() throws InterruptedException {
		...
		//(tem exemplos no site graphStream de estilos de edi√ß√£o)
		...
		/*for(int i = 0; i < 30; i++) {
        	//exemplo de manipula√ß√£o de grafo:
        	grafo.removeEdge("Marielly conhece Juliane");
          //para esperar tempo antes de fazer a√ß√£o:
            Thread.sleep(1000);
        }*/
	}
	...
	public void acaoClique() {
		...
		//importar imagem de fundo:
		grafoCidade.addAttribute("ui.stylesheet", "graph { fill-mode: image-scaled-ratio-max; fill-image: url('imagens/Popula√ß√£o_pernambuco.png'); }");
