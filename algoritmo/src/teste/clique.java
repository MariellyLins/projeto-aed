...
public class clique {
    ...
    public static void main(String[] args) {
       /* Graph grafo = new SingleGraph("Teste");
        ...
        //pessoas que possuem alguma doenca X:
        ...
        while (resp1.equalsIgnoreCase("Sim")) {
            System.out.println("\tVoce deseja adicionar um participante? ");
            resp1 = sc.next();
            while (!resp1.equalsIgnoreCase("Sim") && !resp1.equalsIgnoreCase("Nao")) {
            ...
            if (resp1.equalsIgnoreCase("Sim")) {
                ...
                while (resp2.equalsIgnoreCase("Sim")) {
                    ...
                    resp2 = sc.next();
                    while (!resp2.equalsIgnoreCase("Sim") && !resp2.equalsIgnoreCase("Nao")) {
                        System.out.println("Digite uma resposta valida");
                        resp2 = sc.next();
                    }
                }
        ...
        System.out.println("Pessoas cadastradas para o experimento com o Discreta-Virus:");
        System.out.println(rep.toString());
       ...
       // System.setProperty("org.graphstream.ui.renderer", "org.graphstream.ui.j2dviewer.J2DGraphRenderer");
        ...
        // grafo.addAttribute("ui.stylesheet", "url('//Users//Maely//git//projeto-aednew//algoritmo//GS/Populacao_pernambuco')");
